...
public class OutputUpdateAllEvent implements org.apache.thrift.TBase<OutputUpdateAllEvent, OutputUpdateAllEvent._Fields>, java.io.Serializable, Cloneable, Comparable<OutputUpdateAllEvent> {
  ...
  private static final org.apache.thrift.protocol.TField PERSONALIZED_FIELD_DESC = new org.apache.thrift.protocol.TField("personalized", org.apache.thrift.protocol.TType.BOOL, (short)5);
  ...
  public boolean personalized; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    MSG((short)3, "msg"),
    USER((short)4, "user"),
    PERSONALIZED((short)5, "personalized");
  ...
  private static final int __PERSONALIZED_ISSET_ID = 0;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.USER,_Fields.PERSONALIZED};
  ...
  static {
    ...
    tmpMap.put(_Fields.USER, new org.apache.thrift.meta_data.FieldMetaData("user", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.PERSONALIZED, new org.apache.thrift.meta_data.FieldMetaData("personalized", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
  ...
  public OutputUpdateAllEvent(OutputUpdateAllEvent other) {
    ...
    this.personalized = other.personalized;
  }
  ...
  public OutputUpdateAllEvent setUser(@org.apache.thrift.annotation.Nullable java.lang.String user) {
    this.user = user;
    return this;
  }
  ...
  public OutputUpdateAllEvent setPersonalized(boolean personalized) {
    this.personalized = personalized;
    setPersonalizedIsSet(true);
    return this;
  }

  public void unsetPersonalized() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __PERSONALIZED_ISSET_ID);
  }

  /** Returns true if field personalized is set (has been assigned a value) and false otherwise */
  public boolean isSetPersonalized() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __PERSONALIZED_ISSET_ID);
  }

  public void setPersonalizedIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __PERSONALIZED_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case PERSONALIZED:
      if (value == null) {
        ...
        setPersonalized((java.lang.Boolean)value);
      }
      break;
  ...
  public boolean equals(OutputUpdateAllEvent that) {
    ...
    boolean this_present_personalized = true && this.isSetPersonalized();
    boolean that_present_personalized = true && that.isSetPersonalized();
    if (this_present_personalized || that_present_personalized) {
      if (!(this_present_personalized && that_present_personalized))
        return false;
      if (this.personalized != that.personalized)
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetPersonalized()) ? 131071 : 524287);
    if (isSetPersonalized())
      hashCode = hashCode * 8191 + ((personalized) ? 131071 : 524287);
  ...
  public int compareTo(OutputUpdateAllEvent other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetPersonalized()).compareTo(other.isSetPersonalized());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPersonalized()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.personalized, other.personalized);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class OutputUpdateAllEventStandardScheme extends org.apache.thrift.scheme.StandardScheme<OutputUpdateAllEvent> {
        ...
        switch (schemeField.id) {
          ...
          case 5: // PERSONALIZED
            if (schemeField.type == org.apache.thrift.protocol.TType.BOOL) {
              struct.personalized = iprot.readBool();
              struct.setPersonalizedIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, OutputUpdateAllEvent struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetPersonalized()) {
        oprot.writeFieldBegin(PERSONALIZED_FIELD_DESC);
        oprot.writeBool(struct.personalized);
        oprot.writeFieldEnd();
      }
