...
test.describe('Notebook editor search', () => {
  ...
  // TODO: Port the single-match replace scenario. Monaco's single Replace didn't fire via any
  // e2e gesture tried (Replace button once/twice, Enter in the replace/find input, navigate-then-replace).
  // See https://issues.apache.org/jira/browse/ZEPPELIN-6549.
  test.fixme('updates the match count after a single replace', async () => {});
